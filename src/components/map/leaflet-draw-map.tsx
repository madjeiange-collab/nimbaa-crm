...
// Abidjan — default map center (the drawing map opens on the city, not on
// the admin's device position; the edit-mode preview fitBounds takes over
// when a territory is being edited).
