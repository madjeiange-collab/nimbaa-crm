...
-- deals_del is defined at the end of this file: it references subscriptions,
-- which is created further down (see 0029).
...
-- 0025: follow-up tasks — a rendez-vous or a "retour requis" becomes an owned,
-- dated, closable item instead of just a date on a row.
...
-- ============================================================================
-- 0032 — Essai (voir supabase/migrations/0032_trials.sql)
-- ============================================================================
...
-- ============================================================================
-- 0033 — Suppression d'un chantier jamais commencé (voir migrations/0033_...)
-- ============================================================================
...
-- ============================================================================
-- 0034 — Journal des affaires (voir supabase/migrations/0034_deal_events.sql)
-- ============================================================================
...
-- ============================================================================
-- 0035 — Journal des fiches (voir supabase/migrations/0035_contact_events.sql)
-- ============================================================================
